<?php
    ...
    <?php } ?>  
            <li><a href="?cid=ventas/frm_ver_ventas"><i class="fa fa-circle-o text-yellow"></i> Historial Ventas</a></li>
            <li><a href="?cid=ventas/frm_ventas_anuladas"><i class="fa fa-circle-o text-yellow"></i> Historial Ventas Anuladas</a></li>
            <li><a href="?cid=ventas/frm_detalle"><i class="fa fa-circle-o text-yellow"></i> Detalles de Merma</a></li>
