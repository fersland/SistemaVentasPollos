...
<div class="box box-success">
    ...
    <form id="formulario" method="post" class="form-horizontal" >
        ...
        <div class="form-group">
            <label class="col-md-5">Fecha Adquisición <span class="ast">*</span></label>
            <div class="col-md-7">
        ...
        <div class="form-group">
            <label class="col-md-5"> Número de Factura <span class="ast">*</span></label>
            <div class="col-md-7">
        ...
        <div class="form-group">
            <label class="col-md-5"> Estado físico actual <span class="ast">*</span></label>
            <div class="col-md-7">
