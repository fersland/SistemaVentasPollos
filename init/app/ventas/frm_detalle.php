...
<div class="content-wrapper">
    <section class="content-header">
      <h1><b>Ventas</b> / Historial Ventas Detalle</h1>
      <ol class="breadcrumb">
        <li><a href="?cid=dashboard/init"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li><a href="#">Ventas</a></li>
        <li class="active"><a href="#">Historial de ventas detalle</a></li>
...
<section class="content">
    ...
    <div class="row"><br />
        <div class="col-md-12">
          <?php require_once ("../../controlador/c_ventas/paginarDetalles.php"); ?>
        </div><!-- nav-tabs-custom -->
    </div><!-- /.col -->
  </section>
</div>