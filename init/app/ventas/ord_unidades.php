...
<div class="tab-pane" id="tab_2">
    <form action="../../../controlador/c_clientes/nuevo_cliente_ventas.php" id="formulario" method="post" class="form-horizontal" >
        ...
        <div class="form-group">
            ...
            <label class="col-md-5">Cédula / RUC <span class="ast">(*)</span></label>
            <div class="col-md-7">
...
<div class="modal fade" id="fventa">
      ...
      <input type="hidden" name="eply" value="<?php echo $eply ?>" />
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="text" placeholder="Cédula" id="cedula" name="cliente_fc" class="form-control" onkeypress="return soloNumeros(event)" value="<?php echo $lacedula ?>" />
            </div>
        </div>
        <div class="form-group">
