<?php
  ...
  $ver = $db->prepare("SELECT * FROM access WHERE a_perfil='$session_usuario' AND a_modulo=2 AND a_item=30");
...
$call = $db->prepare("SELECT * FROM tablero");
$call->execute();
$icall = $call->fetch(); ?>
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>ADMINISTRACI&Oacute;N / <b>MENUDENCIA DE COMPRAS</b></h1>
...
<?php if (isset($_POST['register'])) {
        ...
        require_once ("../../controlador/c_menudencia/reg_menudo.php");
    ...
    <form id="form1" name="form1" method="post" class="form-horizontal" >
        ...
        <div class="box-body">   
          ...
          <div class="form-group">
            <label class="col-md-2">Factura de Compra</label>
            <div class="col-md-3">
          ...
          <table class="table">
            ...
            <TBODY>
              <tr>
                <td>105</td>
                <td style="background: gold"><input type="" name="five_pollo" onkeyup="sumar();"></td>
              ...
              <tr>
                ...
                <td style="background: gold"><input type="" name="six_pollo" onkeyup="sumarTwo();"></td>
            ...
            <tfoot>
              <tr style="background: gold">
                <td>Unidad</td>
                <td style="background: gold"><input name="unidad" onkeyup="sumarThree();"></td>
    ...
    <div class="box-footer">
        ...
        <button type="reset" class="btn btn-default"><i class="fa fa-refresh"></i> Limpiar</button>

        <button type="submit" class="btn btn-warning pull-right" value="Registrar" name="register" <?php //echo @$ss ?>><i class="fa fa-check-square-o"></i> Guardar Datos</button>
    ...
    <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            ...
                            <?php require_once ('./'."../../controlador/c_menudencia/paginarMenudo.php"); ?>
