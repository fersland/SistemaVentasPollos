...
$(function(){
	...
	*/
	$('#bs-prod').on('keyup',function(){
		...
		var url = '../../../controlador/c_tipo_aceite/busca_tipo_aceite.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'dato='+dato,
...
function editarProducto(id){
	...
	$('#formulario')[0].reset();
	var url = '../../../controlador/c_tipo_aceite/b_tipo_aceite_show.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function pagination(partida){
	var url = '../../../controlador/c_tipo_aceite/paginarTipoAceite.php';
	$.ajax({
		type:'POST',
		url:url,
