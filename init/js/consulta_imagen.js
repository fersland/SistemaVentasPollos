...
$(function(){
	...
	*/
	$('#bs-prod').on('keyup',function(){
		...
		var url = '../../../controlador/c_mercaderia_imagen/busca_imagen.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'dato='+dato,
...
function editarProducto(id){
	$('#formulario')[0].reset();
	var url = '../../../controlador/c_mercaderia_imagen/b_imagen_show.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function pagination(partida){
	var url = '../../../controlador/c_mercaderia_imagen/paginarImagen.php';
	$.ajax({
		type:'POST',
		url:url,
