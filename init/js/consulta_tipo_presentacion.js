...
$(function(){
	...
	*/
	$('#bs-prod').on('keyup',function(){
		...
		var url = '../../../controlador/c_tipo_presentacion/busca_tipo_presentacion.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'dato='+dato,
...
function editarProducto(id){
	...
	$('#formulario')[0].reset();
	var url = '../../../controlador/c_tipo_presentacion/b_tipo_presentacion_show.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function pagination(partida){
	var url = '../../../controlador/c_tipo_presentacion/paginarTipoPresentacion.php';
	$.ajax({
		type:'POST',
		url:url,
