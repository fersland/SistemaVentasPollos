...
$(function(){
	...
	*/
	$('#bs-prod').on('keyup',function(){
		...
		var url = '../../../controlador/c_trabajo/busca_desc_trabajo.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'dato='+dato,
...
function editarProducto(id){
	...
	$('#formulario')[0].reset();
	var url = '../../../controlador/c_trabajo/b_desc_trabajo_show.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function pagination(partida){
	var url = '../../../controlador/c_trabajo/paginarTrabajo.php';
	$.ajax({
		type:'POST',
		url:url,
