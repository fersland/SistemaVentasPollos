...
$(function(){
	...
	*/
	$('#bs-prod').on('keyup',function(){
		...
		var url = '../../../controlador/c_tipo_vehiculo/busca_tipo_vehiculo.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'dato='+dato,
...
function editarProducto(id){
	...
	$('#formulario')[0].reset();
	var url = '../../../controlador/c_tipo_vehiculo/b_tipo_vehiculo_show.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function pagination(partida){
	var url = '../../../controlador/c_tipo_vehiculo/paginarTipovehiculo.php';
	$.ajax({
		type:'POST',
		url:url,
