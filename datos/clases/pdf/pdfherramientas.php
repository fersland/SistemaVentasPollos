...
$pdf->Cell(59	,5,'Lista de Herramientas',0,1);//end of line
$pdf->Cell(189	,10,'',0,1);//end of line
...
foreach((array) $all as $item){
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(50	,5,strtoupper($item['persona_resp']),0,0);
    $pdf->Cell(50	,5,$item['descripcion'],0,0);
    $pdf->Cell(20	,5,$item['cantidad'],0,0);
	$pdf->Cell(30	,5,$item['proveedor'],0,0);
	$pdf->Cell(25	,5,$item['fecha_adq'],0,0);
    $pdf->Cell(15	,5,$item['numero_factura'],0,0);
	
	$pdf->Cell(189	,0,'',0,1);//end of line
	$pdf->Cell(100	,8,' _______________________________________________________________________________________________________________________',0,1);//end of line
}
$pdf->Output();
