...
class PDF extends FPDF{
    function Header(){
        ...
        $this->Cell(80);
        // Title
        $this->Cell(0,10,'MENUDENCIA DE VENTAS',1,0,'C');
...
$query = DBSTART::abrirDB()->prepare("SELECT * FROM menudenciavn t1 INNER JOIN menuvn t2 ON t1.nnum = t2.nnum WHERE t1.nnum='$id' AND t1.id_estado = 1");
$query->execute();
