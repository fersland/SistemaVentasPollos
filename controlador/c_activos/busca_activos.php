...
$registro = DBSTART::abrirDB()->prepare("select * from c_activos a 
	...
	foreach( (array) $all as $registro2 ){
		echo '<tr>
                ...
                <td>'.$registro2['persona_resp'].'</td>
                    <td><a href="../app/activos/frm_activos_act.php?cid='.$registro2['id_activos'].'" <i class="fa fa-edit"></i></a></td>
                    <td><a href="../app/activos/frm_activos_eli.php?cid='.$registro2['id_activos'].'" ><i class="fa fa-trash"></i></a></td>
                    <td> <a href="javascript:editarProducto('.$registro2['id_activos'].');"><i class="fa fa-eye"></i></a></td>
				</tr>';
	}
}else{
	echo '<tr>
