<?php
    ...
    $args = $cc->prepare("INSERT INTO menudencia (nfactura, nnum, cero5cant, cero5pata, cero5molleja, cero5higado,
                                                cero6pata, cero6molleja, cero6higado,
                                                ceroudpata, ceroudmolleja, ceroudhigado, id_estado, proveedor) VALUES 
                            ('$nfact', '$nfact', '$cant_pollo', '$cinco_pata', '$cinco_molleja', '$cinco_higado',
                                '$seis_pata', '$seis_molleja', '$seis_higado',
                                '$ud_pata', '$ud_molleja', '$ud_higado', 1, '$prov')");
    if ($args->execute()) {
        //  A MENU

        $menu = $cc->prepare("INSERT INTO menu (nfactura, nnum, sumapata, sumamolleja, sumahigado, sumakg, id_estado, proveedor) VALUES 
                                                ('$nfact', '$nfact', '$sumapata', '$sumamolleja', '$sumahigado', '$total', 1, '$prov')");
        $menu->execute();
