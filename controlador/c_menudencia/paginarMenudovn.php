<?php
    ...
    $registro = DBSTART::abrirDB()->prepare("SELECT * FROM menuvn t1 ORDER BY t1.id DESC");
    $registro->execute();
            ...
            <div class="box-body">
              <table id="example" class="table table-bordered table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td><a target="_blank" class="<?php echo @$ee ?>" href="../../datos/clases/pdf/menudenciavn.php?cid=<?php echo $registro2['nnum'] ?> " >
